...
Vaultspeed version: 6.0.0.4, generation date: 2026/03/10 15:17:28
...
if (path_to_mtd / "793_mappings_IVSP_INCR_20260310_151728.json").exists():
	with open(path_to_mtd / "793_mappings_IVSP_INCR_20260310_151728.json") as file: 
...
if (path_to_mtd / "793_FL_mtd_IVSP_INCR_20260310_151728.json").exists():
	with open(path_to_mtd / "793_FL_mtd_IVSP_INCR_20260310_151728.json") as file: 
