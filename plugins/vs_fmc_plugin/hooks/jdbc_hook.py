...
class JdbcHook(DbApiHook):
    ...
    def get_conn(self) -> jaydebeapi.Connection:
        ...
        jdbc_driver_loc: Optional[str] = conn.extra_dejson.get('extra__jdbc__drv_path') or conn.extra_dejson.get('drv_path')
        jdbc_driver_name: Optional[str] = conn.extra_dejson.get('extra__jdbc__drv_clsname') or conn.extra_dejson.get('drv_clsname')
        driver_args = []
